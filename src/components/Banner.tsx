...
const Banner = (props: Props) => {
  return (
    <div className="relative">
      <Image src={bannerBg} alt="banner-bg" className="w-full h-full" />
      <Image
        src={sideBanner}
        alt="side-banner"
      ...
      <div className="absolute top-0 right-[8%] w-[26.5%]">
        <div className="relative">
          <Image className="w-full h-full" src={mainBanner} alt="main-img" />
          <div className="absolute top-[70%]">
            <div className="relative w-[108%] flex items-center">
              <Image src={bgTitle} alt="bg-title" className="w-full h-full" />
